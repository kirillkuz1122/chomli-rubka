      ...
      <div id="authModal" class="modal" hidden>
        ...
        <div class="modal__panel" role="dialog" aria-modal="true" aria-labelledby="authTitle">
          ...
          <form class="modal__form" id="authForm" novalidate>
            ...
            <div class="field input-group"><label>Пароль</label><input class="input" type="password" name="pass" data-required><button type="button" class="input-toggle" aria-label="Показать пароль"><svg width="18" height="18" viewBox="0 0 24 24"><path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12zm11 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" fill="currentColor"/></svg></button></div>
